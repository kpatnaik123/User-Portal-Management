...
<nav class="navbar navbar-light nav" >
  <div class="container-fluid">
    <a class="navbar-brand"><img  id="portimg" src="https://tumo.org/wp-content/uploads/2017/06/portfolio-text-5.png"></a>
    <form class="d-flex" value="redirect">
...
<div class="container s">
  <div class="row">
    <div class="col-sm-12 col-md-7 col-lg-8 col-xl-8">
      ...
      <h1 class="display-1">P.Karthik</h1>
      <p class="lead">
